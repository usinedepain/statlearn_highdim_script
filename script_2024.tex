...
%\begin{figure}
%    \centering
%    \includegraphics[width=.35\textwidth]{graphics/not_overfitted.png}\hspace{.5cm}\includegraphics[width=.35\textwidth]{graphics/%overfitted.png}
%    \caption{Two modes trained on a noisy dataset (which without noise should be linearly separable. The simple, linear classifier on the left can handle this, but the complicated model on the right has overfit to the noise in the data.}
%    \label{fig:overfit}
%\end{figure}
